...
O projeto foi conduzido como uma Análise Exploratória de Dados (EDA) utilizando Python e as seguintes etapas foram seguidas:

- Importação de bibliotecas e dados
- Análise de informações básicas e estatíticas descritivas do dataset
